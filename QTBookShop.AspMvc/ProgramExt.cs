...
#endif
            builder.Services.AddTransient<Logic.Contracts.App.IBooksAccess, Logic.Controllers.App.BooksController>();
            builder.Services.AddTransient<Logic.Contracts.Base.IAuthorsAccess, Logic.Controllers.Base.AuthorsController>();
            builder.Services.AddTransient<Logic.Contracts.Base.ICategoriesAccess, Logic.Controllers.Base.CategoriesController>();
